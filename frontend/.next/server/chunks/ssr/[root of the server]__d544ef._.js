...
const AuthProvider = ({ children })=>{
    ...
    const fetchProfile = async (token)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get("http://localhost:8000/users/profile", {
                headers: {
    ...
    const login = async (email, password)=>{
        const res = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post("http://localhost:8000/auth/login", {
            email,
            password
        });
...
;
const Login = ()=>{
    const authContext = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["AuthContext"]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d544ef._.js.map